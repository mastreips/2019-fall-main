...
* Course website: [GitHub datasci-w266/2019-fall-main](../../../)
* [Piazza](https://piazza.com/berkeley/fall2019/datasciw266) - we'll use this for Q&A, and this will be the fastest way to reach the course staff. Note that you can post anonymously, and/or make posts visible only to instructors for private questions.
...
<tr><!--- Entities -->
  <td><strong>Week&nbsp;10</strong><br>(October&nbsp;29)</td>
  <td>Entities</td>
  <td><ul>
...
<tr><!--- POS Tagging -->
  <td><strong>Week&nbsp;11</strong><br>(November&nbsp;5)</td>
...
<tr><!--- Dependency Parsing -->
  <td><strong>Week&nbsp;12</strong><br>(November&nbsp;19)</td>
...
<tr><!--- Constituency Parsing -->
  <td><strong>Week&nbsp;12&nbsp;contd</strong><br>(November&nbsp;26)</td>
