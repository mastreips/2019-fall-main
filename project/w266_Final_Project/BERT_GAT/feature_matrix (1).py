...
'''
TURN ON/OFF for Simple_GAT vs GAT_Opt
'''
class FeatureMatrix:
...
#             for file in os.listdir(self.base_path + folder + "/" + subfolder):
            ...
            for file in os.listdir("../../../../Fake-News-Detection/dataset/" + folder + "/" + subfolder): #GAT_Opt
#             for file in os.listdir("../Fake-News-Detection/dataset/" + folder + "/" + subfolder): #Simple_GAT
                if file.endswith(".json"):
#                     data_list.append(self.get_data_from_file(self.base_path + folder + "/" + subfolder + "/" + file)) #Simple_GAT
                    data_list.append(self.get_data_from_file("../../../../Fake-News-Detection/dataset/"  + folder + "/" + subfolder + "/" + file)) #GAT_Opt
...
#         for subfolder in ["FakeNewsContent", "RealNewsContent"]:
#             for file in os.listdir(self.base_path + folder + "/" + subfolder):
#             #for file in os.listdir("/Fake-News-Detection/" + folder + "/" + subfolder):
#                 if file.endswith(".json"):
...
#         all_data_df = all_data_df.sample(frac=1)  #turned off to be able to track articles
        ...
        return features_df, all_data_df
