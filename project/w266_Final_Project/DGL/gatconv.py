...
class GATConv(nn.Module):
    ...
    def __init__(self,
        ...
        self.leaky_relu = nn.LeakyReLU(negative_slope)
                #added
        self.attn_all = nn.Parameter(th.FloatTensor(size=(9752, num_heads, 1)))
        if residual:
    ...
    def reset_parameters(self):
        ...
        nn.init.xavier_normal_(self.attn_r, gain=gain)
                ## ADDED
        nn.init.xavier_normal_(self.attn_all, gain=gain)
...
#         print(type(graph.edata['a']))
#         print(graph.edata['a'].size())
        self.attn_all.data = graph.edata['a'] #ADDED
#         print('******HEREIAM*********')
#         print(graph.edata['a'])
        # message passing
